# Гайд по Skript на русском языке
...
* Условия могут быть **in-line**: `broadcast "Привет" if player has permission "vip"`. Это удобно для коротких проверок.
